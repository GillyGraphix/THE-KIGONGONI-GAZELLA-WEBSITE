...
<div class="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
    <div class="container mx-auto px-4 py-3">
        <nav class="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">
            ...
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            <span class="text-kigongoniOrange">{{ __('Standard Triple Room') }}</span>
        </nav>
    </div>
</div>
    ...
    <div class="container mx-auto px-4 py-12 max-w-7xl">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-kigongoniOrange/30 dark:border-kigongoniOrange/40 overflow-hidden">
                <div class="bg-kigongoniBlue px-6 py-4 flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-white font-black uppercase text-sm tracking-wide">{{ __('Standard Triple Room') }}</h3>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8 items-start">
                        <div>
                            ...
                            <div class="grid grid-cols-7 mb-1">
                                ...
                                <div class="text-center text-[9px] font-black text-gray-400 uppercase py-1">{{ $d }}</div>
                                @endforeach
                            </div>
        ...
        <div class="relative rounded-3xl overflow-hidden mb-10 shadow-2xl" data-aos="fade-up">
            <div class="absolute inset-0">
                <img src="{{ asset('images/rooms/standard-triple/main.jpg') }}"
        ...
        <div class="grid grid-cols-4 grid-rows-2 gap-3 h-[420px] md:h-[500px] mb-12 rounded-2xl overflow-hidden" data-aos="fade-up">
            <div class="col-span-4 md:col-span-2 md:row-span-2 relative overflow-hidden group cursor-pointer" onclick="openLightbox(0)">
                <img src="{{ asset('images/rooms/standard-triple/main.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&w=1000&q=80'" alt="Main View" class="w-full h-full object-cover group-hover:scale-105 transition duration-700">
            ...
            <div class="col-span-2 md:col-span-1 relative overflow-hidden group cursor-pointer" onclick="openLightbox(1)">
                <img src="{{ asset('images/rooms/standard-triple/bathroom.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?auto=format&fit=crop&w=600&q=80'" alt="Bathroom" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
            ...
            <div class="col-span-2 md:col-span-1 relative overflow-hidden group cursor-pointer" onclick="openLightbox(2)">
                <img src="{{ asset('images/rooms/standard-triple/desk.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=600&q=80'" alt="Desk Area" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition duration-300"></div>
            ...
            <div class="col-span-2 md:col-span-1 relative overflow-hidden group cursor-pointer" onclick="openLightbox(3)">
                <img src="{{ asset('images/rooms/standard-triple/view.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=600&q=80'" alt="Room View" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                <div class="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition duration-300"></div>
            ...
            <div class="col-span-2 md:col-span-1 relative overflow-hidden group cursor-pointer" onclick="openLightbox(4)">
                <img src="{{ asset('images/rooms/standard-triple/window-side.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1595599872002-9154efcf5b8e?auto=format&fit=crop&w=600&q=80'" alt="Window Side" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                ...
                <div data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                        <table class="w-full text-sm">
                            <tbody>
                                <tr class="border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50"><td class="px-5 py-3.5 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs w-40">{{ __('Room Size') }}</td><td class="px-5 py-3.5 font-semibold text-gray-800 dark:text-white">~35 m²</td></tr>
                                <tr class="border-b border-gray-100 dark:border-gray-700"><td class="px-5 py-3.5 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">{{ __('Bed Type') }}</td><td class="px-5 py-3.5 font-semibold text-gray-800 dark:text-white">{{ __('1 Double Bed (Queen/King)') }} + 1 Single Bed</td></tr>
                                <tr class="border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50"><td class="px-5 py-3.5 font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-xs">{{ __('Max Guests') }}</td><td class="px-5 py-3.5 font-semibold text-gray-800 dark:text-white">{{ __('3 Adults') }}</td></tr>
            ...
            <div class="hidden lg:block">
                <div id="booking-calendar" class="sticky top-28 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden" data-aos="fade-left">
                    <div class="bg-kigongoniBlue dark:bg-gray-900 p-5 text-white">
                        ...
                        <h3 class="text-xl font-black uppercase">{{ __('Standard Triple Room') }}</h3>
                    </div>
                    <div class="p-4">
                        @if($checkinFormatted && $checkoutFormatted)
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-7 mb-1">
                        ...
                        <div class="text-center text-[10px] font-black text-gray-400 uppercase py-1">{{ $day }}</div>
                        @endforeach
                    </div>
...
// ─── Lightbox ─────────────────────────────────────────────────
const galleryImages = [
    { src: "{{ asset('images/rooms/standard-triple/main.jpg') }}",        fallback: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&w=1200&q=80', label: '{{ __("Main View") }}' },
    { src: "{{ asset('images/rooms/standard-triple/bathroom.jpg') }}",    fallback: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?auto=format&fit=crop&w=1200&q=80', label: '{{ __("Bathroom") }}' },
    { src: "{{ asset('images/rooms/standard-triple/desk.jpg') }}",        fallback: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=1200&q=80', label: '{{ __("Desk Area") }}' },
    { src: "{{ asset('images/rooms/standard-triple/view.jpg') }}",        fallback: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&w=1200&q=80', label: '{{ __("Room View") }}' },
    { src: "{{ asset('images/rooms/standard-triple/window-side.jpg') }}", fallback: 'https://images.unsplash.com/photo-1595599872002-9154efcf5b8e?auto=format&fit=crop&w=1200&q=80', label: '{{ __("Window Side") }}' },
];
let currentImg = 0;
