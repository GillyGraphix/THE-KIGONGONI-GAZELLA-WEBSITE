                    ...
                    <div class="flex-1 rounded-2xl p-6 flex flex-col justify-between gap-6"
                        ...
                        <div>
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="text-kigongoniOrange text-xs font-black uppercase tracking-[0.3em]">{{ __('Accommodation') }} · {{ __('Standard Room') }}</span>
                            </div>
                            <h1 class="text-5xl md:text-6xl font-black text-white uppercase tracking-tight leading-none mb-5">
                                {{ __('Standard') }}<br>
                                <span class="text-kigongoniOrange" style="text-shadow: 0 0 40px rgba(239,74,37,0.5);">{{ __('Family') }}</span>
                            </h1>
